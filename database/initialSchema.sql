...
CREATE OR REPLACE FUNCTION "public"."delete_old_alert_logs"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  DELETE FROM public.haze_alert_logs
  WHERE sent_at < NOW() - INTERVAL '30 days';
END;
$$;


ALTER FUNCTION "public"."delete_old_alert_logs"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_old_real_time_stations"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  DELETE FROM public.real_time_stations
...
CREATE OR REPLACE FUNCTION "public"."match_documents"("query_embedding" "public"."halfvec", "match_count" integer DEFAULT NULL::integer, "filter" "jsonb" DEFAULT '{}'::"jsonb") RETURNS TABLE("id" "uuid", "content" "text", "metadata" "jsonb", "similarity" double precision)
    LANGUAGE "plpgsql"
    AS $$
...
ALTER FUNCTION "public"."match_documents"("query_embedding" "public"."halfvec", "match_count" integer, "filter" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."match_policy_documents"("query_embedding" "public"."halfvec", "match_count" integer DEFAULT 5, "filter" "jsonb" DEFAULT '{}'::"jsonb") RETURNS TABLE("id" "uuid", "content" "text", "metadata" "jsonb", "similarity" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
  SELECT policy_documents.id, policy_documents.content,
         jsonb_build_object('title', title, 'source', source, 'category', category),
         1 - (policy_documents.embedding <=> query_embedding)
...
ALTER FUNCTION "public"."match_policy_documents"("query_embedding" "public"."halfvec", "match_count" integer, "filter" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."unpack_n8n_metadata"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  -- Extract values from the JSON block n8n sends and assign them to your columns
  NEW.title     := COALESCE(NEW.metadata->>'title', 'Untitled');
  NEW.category  := NEW.metadata->>'category';
  NEW.source    := NEW.metadata->>'source';
  RETURN NEW;
END;
$$;


ALTER FUNCTION "public"."unpack_n8n_metadata"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."api_usage_logs" (
    ...
    "tokens_or_calls_consumed" integer DEFAULT 1 NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS "public"."chat_memory_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "public"."chat_memory_id_seq" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."haze_alert_logs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid" NOT NULL,
    "triggered_by" "text" NOT NULL,
    "aqi_at_trigger" integer,
    "safety_status" "text",
    "estimated_clearance_hours" numeric,
    "sent_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    "label" "text",
    "station_name" "text",
    "pm25_at_trigger" numeric,
    "pm25_threshold" numeric,
    "aqi_threshold" integer,
    CONSTRAINT "haze_alert_logs_triggered_by_check" CHECK (("triggered_by" = ANY (ARRAY['app_push'::"text", 'telegram_push'::"text"])))
);


ALTER TABLE "public"."haze_alert_logs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."real_time_stations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "wind_degrees" numeric,
    "updated_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    "station_wind_speed_ms" numeric,
    "humidity" numeric,
    "temperature" numeric,
    "dominant_pollutant" "text",
    "forecast_pm25_tomorrow" numeric,
    "forecast_pm25_day2" numeric,
    "forecast_pm10_tomorrow" numeric,
    "forecast_pm10_day2" numeric,
    "last_pm10" numeric,
    ...
    "so2" numeric,
    "co" numeric,
    "forecast_uvi_tomorrow" numeric,
    "forecast_uvi_day2" numeric,
    "last_updated" "text"
);


ALTER TABLE "public"."real_time_stations" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."telegram_user_locations" (
...
ALTER TABLE "public"."telegram_user_locations" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."device_push_tokens"
    ADD CONSTRAINT "device_push_tokens_user_id_onesignal_player_id_key" UNIQUE ("user_id", "onesignal_player_id");
...
ALTER TABLE ONLY "public"."haze_alert_logs"
    ADD CONSTRAINT "haze_alert_logs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."real_time_stations"
    ADD CONSTRAINT "real_time_stations_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."telegram_user_locations"
    ADD CONSTRAINT "telegram_user_locations_pkey" PRIMARY KEY ("chat_id");
...
ALTER TABLE ONLY "public"."users"
    ADD CONSTRAINT "users_telegram_pairing_nonce_key" UNIQUE ("telegram_pairing_nonce");
...
CREATE INDEX "favorite_locations_geo_idx" ON "public"."favorite_locations" USING "gist" ("location");



CREATE INDEX "policy_documents_embedding_idx" ON "public"."policy_documents" USING "hnsw" ("embedding" "public"."halfvec_cosine_ops");



CREATE INDEX "real_time_stations_geo_idx" ON "public"."real_time_stations" USING "gist" ("location");



CREATE INDEX "real_time_stations_station_time_idx" ON "public"."real_time_stations" USING "btree" ("station_name", "updated_at" DESC);



CREATE INDEX "telegram_user_locations_user_id_idx" ON "public"."telegram_user_locations" USING "btree" ("user_id");



CREATE OR REPLACE TRIGGER "trg_unpack_n8n_metadata" BEFORE INSERT ON "public"."policy_documents" FOR EACH ROW EXECUTE FUNCTION "public"."unpack_n8n_metadata"();
...
ALTER TABLE ONLY "public"."haze_alert_logs"
    ADD CONSTRAINT "haze_alert_logs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "admin_full_access_logs" ON "public"."haze_alert_logs" USING ("public"."is_admin"("auth"."uid"()));



CREATE POLICY "admin_full_access_stations" ON "public"."real_time_stations" USING ("public"."is_admin"("auth"."uid"()));



CREATE POLICY "admin_full_access_usage" ON "public"."api_usage_logs" USING ("public"."is_admin"("auth"."uid"()));



CREATE POLICY "admin_full_access_users" ON "public"."users" USING ("public"."is_admin"("auth"."uid"()));



CREATE POLICY "alert_logs_owner_read" ON "public"."haze_alert_logs" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "device_tokens_owner" ON "public"."device_push_tokens" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "favorite_locations_owner" ON "public"."favorite_locations" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



ALTER TABLE "public"."haze_alert_logs" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."real_time_stations" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "stations_public_read" ON "public"."real_time_stations" FOR SELECT USING (true);
...
GRANT ALL ON FUNCTION "public"."delete_old_alert_logs"() TO "anon";
GRANT ALL ON FUNCTION "public"."delete_old_alert_logs"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_old_alert_logs"() TO "service_role";



GRANT ALL ON FUNCTION "public"."delete_old_real_time_stations"() TO "anon";
GRANT ALL ON FUNCTION "public"."delete_old_real_time_stations"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_old_real_time_stations"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."match_documents"("query_embedding" "public"."halfvec", "match_count" integer, "filter" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."match_documents"("query_embedding" "public"."halfvec", "match_count" integer, "filter" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_documents"("query_embedding" "public"."halfvec", "match_count" integer, "filter" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."match_policy_documents"("query_embedding" "public"."halfvec", "match_count" integer, "filter" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."match_policy_documents"("query_embedding" "public"."halfvec", "match_count" integer, "filter" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_policy_documents"("query_embedding" "public"."halfvec", "match_count" integer, "filter" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."unpack_n8n_metadata"() TO "anon";
GRANT ALL ON FUNCTION "public"."unpack_n8n_metadata"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."unpack_n8n_metadata"() TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."chat_memory_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."chat_memory_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."chat_memory_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."haze_alert_logs" TO "anon";
GRANT ALL ON TABLE "public"."haze_alert_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."haze_alert_logs" TO "service_role";
...
GRANT ALL ON TABLE "public"."real_time_stations" TO "anon";
GRANT ALL ON TABLE "public"."real_time_stations" TO "authenticated";
GRANT ALL ON TABLE "public"."real_time_stations" TO "service_role";



GRANT ALL ON TABLE "public"."telegram_user_locations" TO "anon";
GRANT ALL ON TABLE "public"."telegram_user_locations" TO "authenticated";
GRANT ALL ON TABLE "public"."telegram_user_locations" TO "service_role";
...
-- Schedule: Clean up old alert logs (daily at 1 AM)
select cron.unschedule('cleanup-old-alert-logs');
select cron.schedule(
  'cleanup-old-alert-logs',
  '0 1 * * *',
  'select public.delete_old_alert_logs()'
);

-- Schedule: Clean up old AQI data (daily at midnight)
select cron.schedule(
  'cleanup-old-aqi-data',
  '0 0 * * *',
  'select public.delete_old_real_time_stations()'
);
